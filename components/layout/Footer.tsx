const Footer = () => {
   return (
      <footer className="bg-[#f8fafc] dark:bg-slate-950 py-12 text-[13px] text-slate-500 dark:text-slate-400 font-medium w-full border-t border-slate-100 dark:border-white/5 transition-colors">
         <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col md:items-end gap-2">
               <span className="text-gray-900 dark:text-white font-bold text-sm mb-2 transition-colors">Oyster Kode Club</span>
               <div className="flex flex-wrap md:justify-end gap-5">
                  <a href="mailto:oysterkode@ritindia.edu" className="cursor-pointer text-slate-400 dark:text-slate-500 hover:text-[#ea4335] dark:hover:text-[#ea4335] transition-all" aria-label="Mail" title="Mail">
                  ...
                  <a href="#" className="cursor-pointer text-slate-400 dark:text-slate-500 hover:text-[#E1306C] dark:hover:text-[#E1306C] transition-all" aria-label="Instagram" title="Instagram">
                  ...
                  <a href="https://www.linkedin.com/in/oyster-kode-club/" target="_blank" rel="noopener noreferrer" className="cursor-pointer text-slate-400 dark:text-slate-500 hover:text-[#0077b5] dark:hover:text-[#0077b5] transition-all" aria-label="LinkedIn" title="LinkedIn">
