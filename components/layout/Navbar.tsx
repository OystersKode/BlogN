      ...
      <div className="w-full max-w-[1336px] mx-auto px-4 sm:px-6">
        <div className="flex justify-between h-full items-center">
          ...
          <div className="flex items-center gap-6">
            <Link href="/" className="text-[26px] font-black text-gray-900 dark:text-white tracking-tighter font-serif transition-colors">
              BlogN
            </Link>
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            {session ? (
              <>
                <Link href="/editor" className="hidden sm:flex items-center gap-2 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                  <Edit size={22} strokeWidth={1.5} />
                  <span className="text-[15px] font-medium border-r border-gray-100 dark:border-white/10 pr-4 mr-2">Write</span>
                </Link>
        ...
        <div className="fixed inset-0 z-50 flex">
           ...
           <div className="relative w-[280px] sm:w-[320px] bg-white dark:bg-slate-950 h-full shadow-2xl flex flex-col px-8 py-8 animate-in slide-in-from-left duration-300 z-[60] overflow-y-auto">
              <div className="flex justify-between items-center mb-10 pb-6 border-b border-gray-100 dark:border-white/10">
                 <Link href="/" className="text-2xl font-black text-gray-900 dark:text-white font-serif tracking-tighter" onClick={() => setIsMobileMenuOpen(false)}>BlogN</Link>
